...
- (IBAction)binaryChangedAction:(id)sender {
    [BD_PopListViewManager ShowPopViewWithlistDataSource:@[@"二进制",@"十进制",@"十六进制"] textField:_binaryBtn viewController:[self GetSubordinateControllerForSelf] complete:^(NSString *title) {
...
-(void)cellBlockAction:(UIButton *)sourceView array:(NSArray *)array{
    [BD_PopListViewManager ShowPopViewWithlistDataSource:array textField:sourceView viewController:[self GetSubordinateControllerForSelf] complete:^(NSString *title) {
