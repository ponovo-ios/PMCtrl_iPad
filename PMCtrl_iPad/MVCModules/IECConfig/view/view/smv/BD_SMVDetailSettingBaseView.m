...
-(void)createViews{
    ...
    BD_SMVDetailSettingWeakSignalMapBaseView *weakMapView = [[NSBundle mainBundle]loadNibNamed:@"BD_SMVDetailSettingWeakSignalMapBaseView" owner:nil options:nil].lastObject;
