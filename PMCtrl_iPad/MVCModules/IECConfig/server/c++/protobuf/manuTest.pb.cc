...
class TestItemResultDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<TestItemResult> {
...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItemResult, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItemResult, factvalue_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItemResult, facttime_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItemResult, freturnvalue_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItemResult, freturntime_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 27, -1, sizeof(TestItemResult)},
  { 35, -1, sizeof(realPara)},
  { 41, -1, sizeof(TestItem_Switch_State)},
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&_TestItemResult_default_instance_),
...
void TableStruct::Shutdown() {
  ...
  _TestItemResult_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TestItemResult_default_instance_.DefaultConstruct();
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "ra\030\006 \001(\0132\030.ManuTestPara.SwitchPara\"`\n\016Te"
      "stItemResult\022\021\n\tfActValue\030\001 \001(\002\022\020\n\010fActT"
      "ime\030\002 \001(\r\022\024\n\014fReturnValue\030\003 \001(\002\022\023\n\013fRetu"
      "rnTime\030\004 \001(\r\"p\n\010realPara\0220\n\014oacanlogpara"
      "\030\001 \001(\0132\032.OutPutCommon.acanalogpara\0222\n\016oa"
      "cdigitalpara\030\002 \001(\0132\032.OutPutCommon.acanal"
      "ogpara\"+\n\025TestItem_Switch_State\022\022\n\nnibin"
      "state\030\001 \001(\rb\006proto3"
  };
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int TestItemResult::kFActValueFieldNumber;
const int TestItemResult::kFActTimeFieldNumber;
const int TestItemResult::kFReturnValueFieldNumber;
const int TestItemResult::kFReturnTimeFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
TestItemResult::TestItemResult()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:ManuTestPara.TestItemResult)
}
TestItemResult::TestItemResult(const TestItemResult& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(NULL),
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&factvalue_, &from.factvalue_,
    reinterpret_cast<char*>(&freturntime_) -
    reinterpret_cast<char*>(&factvalue_) + sizeof(freturntime_));
  // @@protoc_insertion_point(copy_constructor:ManuTestPara.TestItemResult)
}

void TestItemResult::SharedCtor() {
  ::memset(&factvalue_, 0, reinterpret_cast<char*>(&freturntime_) -
    reinterpret_cast<char*>(&factvalue_) + sizeof(freturntime_));
  _cached_size_ = 0;
}

TestItemResult::~TestItemResult() {
  // @@protoc_insertion_point(destructor:ManuTestPara.TestItemResult)
  SharedDtor();
}

void TestItemResult::SharedDtor() {
}

void TestItemResult::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* TestItemResult::descriptor() {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_manuTest_2eproto::file_level_metadata[3].descriptor;
}

const TestItemResult& TestItemResult::default_instance() {
  protobuf_manuTest_2eproto::InitDefaults();
  return *internal_default_instance();
}

TestItemResult* TestItemResult::New(::google::protobuf::Arena* arena) const {
  TestItemResult* n = new TestItemResult;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void TestItemResult::Clear() {
// @@protoc_insertion_point(message_clear_start:ManuTestPara.TestItemResult)
  ::memset(&factvalue_, 0, reinterpret_cast<char*>(&freturntime_) -
    reinterpret_cast<char*>(&factvalue_) + sizeof(freturntime_));
}

bool TestItemResult::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:ManuTestPara.TestItemResult)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ManuTestPara.TestItemResult)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ManuTestPara.TestItemResult)
  return false;
#undef DO_
}

void TestItemResult::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:ManuTestPara.TestItemResult)
  // float fActValue = 1;
  if (this->factvalue() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(1, this->factvalue(), output);
  }

  // uint32 fActTime = 2;
  if (this->facttime() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->facttime(), output);
  }

  // float fReturnValue = 3;
  if (this->freturnvalue() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->freturnvalue(), output);
  }

  // uint32 fReturnTime = 4;
  if (this->freturntime() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->freturntime(), output);
  }

  // @@protoc_insertion_point(serialize_end:ManuTestPara.TestItemResult)
}

::google::protobuf::uint8* TestItemResult::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic;  // Unused
  // @@protoc_insertion_point(serialize_to_array_start:ManuTestPara.TestItemResult)
  // float fActValue = 1;
  if (this->factvalue() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(1, this->factvalue(), target);
  }

  // uint32 fActTime = 2;
  if (this->facttime() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->facttime(), target);
  }

  // float fReturnValue = 3;
  if (this->freturnvalue() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(3, this->freturnvalue(), target);
  }

  // uint32 fReturnTime = 4;
  if (this->freturntime() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->freturntime(), target);
  }

  // @@protoc_insertion_point(serialize_to_array_end:ManuTestPara.TestItemResult)
  return target;
}

size_t TestItemResult::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ManuTestPara.TestItemResult)
  size_t total_size = 0;
...
void TestItemResult::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ManuTestPara.TestItemResult)
  GOOGLE_DCHECK_NE(&from, this);
  const TestItemResult* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const TestItemResult>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ManuTestPara.TestItemResult)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ManuTestPara.TestItemResult)
    MergeFrom(*source);
  }
}

void TestItemResult::MergeFrom(const TestItemResult& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ManuTestPara.TestItemResult)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  if (from.factvalue() != 0) {
    set_factvalue(from.factvalue());
  }
  if (from.facttime() != 0) {
    set_facttime(from.facttime());
  }
  if (from.freturnvalue() != 0) {
    set_freturnvalue(from.freturnvalue());
  }
  if (from.freturntime() != 0) {
    set_freturntime(from.freturntime());
  }
}

void TestItemResult::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:ManuTestPara.TestItemResult)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void TestItemResult::CopyFrom(const TestItemResult& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:ManuTestPara.TestItemResult)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TestItemResult::IsInitialized() const {
  return true;
}

void TestItemResult::Swap(TestItemResult* other) {
  if (other == this) return;
  InternalSwap(other);
}
void TestItemResult::InternalSwap(TestItemResult* other) {
  std::swap(factvalue_, other->factvalue_);
  std::swap(facttime_, other->facttime_);
  std::swap(freturnvalue_, other->freturnvalue_);
  std::swap(freturntime_, other->freturntime_);
  std::swap(_cached_size_, other->_cached_size_);
}

::google::protobuf::Metadata TestItemResult::GetMetadata() const {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
...
// float fActValue = 1;
void TestItemResult::clear_factvalue() {
  factvalue_ = 0;
}
float TestItemResult::factvalue() const {
  // @@protoc_insertion_point(field_get:ManuTestPara.TestItemResult.fActValue)
  return factvalue_;
}
void TestItemResult::set_factvalue(float value) {
...
// uint32 fActTime = 2;
void TestItemResult::clear_facttime() {
  facttime_ = 0u;
}
::google::protobuf::uint32 TestItemResult::facttime() const {
  // @@protoc_insertion_point(field_get:ManuTestPara.TestItemResult.fActTime)
  return facttime_;
}
void TestItemResult::set_facttime(::google::protobuf::uint32 value) {
...
// float fReturnValue = 3;
void TestItemResult::clear_freturnvalue() {
  freturnvalue_ = 0;
}
float TestItemResult::freturnvalue() const {
  // @@protoc_insertion_point(field_get:ManuTestPara.TestItemResult.fReturnValue)
  return freturnvalue_;
}
void TestItemResult::set_freturnvalue(float value) {
...
// uint32 fReturnTime = 4;
void TestItemResult::clear_freturntime() {
  freturntime_ = 0u;
}
::google::protobuf::uint32 TestItemResult::freturntime() const {
  // @@protoc_insertion_point(field_get:ManuTestPara.TestItemResult.fReturnTime)
  return freturntime_;
}
void TestItemResult::set_freturntime(::google::protobuf::uint32 value) {
...
const ::google::protobuf::Descriptor* realPara::descriptor() {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_manuTest_2eproto::file_level_metadata[4].descriptor;
}
...
::google::protobuf::Metadata realPara::GetMetadata() const {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_manuTest_2eproto::file_level_metadata[4];
}
...
TestItem_Switch_State::TestItem_Switch_State()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:ManuTestPara.TestItem_Switch_State)
}
TestItem_Switch_State::TestItem_Switch_State(const TestItem_Switch_State& from)
  ...
  // @@protoc_insertion_point(copy_constructor:ManuTestPara.TestItem_Switch_State)
}
...
TestItem_Switch_State::~TestItem_Switch_State() {
  // @@protoc_insertion_point(destructor:ManuTestPara.TestItem_Switch_State)
  SharedDtor();
}
...
const ::google::protobuf::Descriptor* TestItem_Switch_State::descriptor() {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_manuTest_2eproto::file_level_metadata[5].descriptor;
}
...
// @@protoc_insertion_point(message_clear_start:ManuTestPara.TestItem_Switch_State)
  nibinstate_ = 0u;
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:ManuTestPara.TestItem_Switch_State)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ManuTestPara.TestItem_Switch_State)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ManuTestPara.TestItem_Switch_State)
  return false;
#undef DO_
}
...
void TestItem_Switch_State::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:ManuTestPara.TestItem_Switch_State)
  // uint32 nibinstate = 1;
  if (this->nibinstate() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->nibinstate(), output);
  }

  // @@protoc_insertion_point(serialize_end:ManuTestPara.TestItem_Switch_State)
}

::google::protobuf::uint8* TestItem_Switch_State::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic;  // Unused
  // @@protoc_insertion_point(serialize_to_array_start:ManuTestPara.TestItem_Switch_State)
  // uint32 nibinstate = 1;
  if (this->nibinstate() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->nibinstate(), target);
  }

  // @@protoc_insertion_point(serialize_to_array_end:ManuTestPara.TestItem_Switch_State)
  return target;
}

size_t TestItem_Switch_State::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ManuTestPara.TestItem_Switch_State)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:ManuTestPara.TestItem_Switch_State)
  GOOGLE_DCHECK_NE(&from, this);
  const TestItem_Switch_State* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const TestItem_Switch_State>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ManuTestPara.TestItem_Switch_State)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ManuTestPara.TestItem_Switch_State)
    MergeFrom(*source);
  }
}

void TestItem_Switch_State::MergeFrom(const TestItem_Switch_State& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ManuTestPara.TestItem_Switch_State)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
...
// @@protoc_insertion_point(generalized_copy_from_start:ManuTestPara.TestItem_Switch_State)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:ManuTestPara.TestItem_Switch_State)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata TestItem_Switch_State::GetMetadata() const {
  protobuf_manuTest_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_manuTest_2eproto::file_level_metadata[5];
}
