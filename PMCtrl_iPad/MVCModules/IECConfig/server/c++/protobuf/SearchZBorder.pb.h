...
class TestItem_SearchZBorder_Result : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SearchZBorder.TestItem_SearchZBorder_Result) */ {
 public:
  ...
  // bool bAct = 6;
  void clear_bact();
  static const int kBActFieldNumber = 6;
  bool bact() const;
  void set_bact(bool value);

  // bool bEnd = 7;
  void clear_bend();
  static const int kBEndFieldNumber = 7;
  bool bend() const;
  void set_bend(bool value);

  // uint32 nibinstate = 8;
  void clear_nibinstate();
  static const int kNibinstateFieldNumber = 8;
...
class Items : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SearchZBorder.Items) */ {
 public:
  ...
  ::SearchZBorder::OutPutType outputtype() const;
  void set_outputtype(::SearchZBorder::OutPutType value);
...
// bool bAct = 6;
inline void TestItem_SearchZBorder_Result::clear_bact() {
  bact_ = false;
}
inline bool TestItem_SearchZBorder_Result::bact() const {
  // @@protoc_insertion_point(field_get:SearchZBorder.TestItem_SearchZBorder_Result.bAct)
  return bact_;
}
inline void TestItem_SearchZBorder_Result::set_bact(bool value) {
...
template <> struct is_proto_enum< ::SearchZBorder::OutPutType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::SearchZBorder::OutPutType>() {
  return ::SearchZBorder::OutPutType_descriptor();
}
