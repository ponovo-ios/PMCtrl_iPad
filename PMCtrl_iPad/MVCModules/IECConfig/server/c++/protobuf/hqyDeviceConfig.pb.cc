...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, -1, sizeof(device)},
  { 8, -1, sizeof(devicechaneldesc)},
  { 37, -1, sizeof(range)},
  { 43, -1, sizeof(analogmap)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "\032\026CompensationPara.proto\"\321\001\n\006device\0226\n\013o"
      ...
      "ionmngr\030\004 \001(\0132\025.Compensation.modules\"\265\005\n"
      "\020devicechaneldesc\022\026\n\016smvmaxgroupnum\030\001 \001("
      "\r\022\033\n\023goosepubmaxgroupnum\030\002 \001(\r\022\032\n\022goosei"
      "nmaxgroupnum\030\003 \001(\r\022\033\n\023analogvoltmaxchane"
      "l\030\004 \001(\r\022\036\n\026analogcurrentmaxchanel\030\005 \001(\r\022"
      "\017\n\007ffremax\030\006 \001(\002\022\026\n\016fanalogVoltmax\030\007 \001(\002"
      "\022\031\n\021fanalogcurrentmax\030\010 \001(\002\022\020\n\010ishasudc\030"
      "\t \001(\010\022\017\n\007fudcmax\030\n \001(\002\022\020\n\010ishasidc\030\013 \001(\010"
      "\022\017\n\007fidcmax\030\014 \001(\002\022\021\n\tnbimaxnum\030\r \001(\r\022\021\n\t"
      "nbomaxnum\030\016 \001(\r\022\027\n\017ishasDigitalout\030\017 \001(\010"
      "\022\032\n\022ishasvoltanalogout\030\020 \001(\010\022\031\n\021ishascur"
      "analogout\030\021 \001(\010\022\031\n\021nDigitalmodulenum\030\022 \001"
      "(\r\022\035\n\025nDigitalmodulePortNum\030\023 \001(\r\022\036\n\026nAn"
      "alogVoltModuleCount\030\024 \001(\r\022!\n\031nAnalogVolt"
      "ModuleBeginNum\030\025 \001(\r\022$\n\034nAnalogVoltModul"
      "eChanleCount\030\026 \003(\r\022!\n\031nAnalogCurrentModu"
      "leCount\030\027 \001(\r\022$\n\034nAnalogCurrentModuleBeg"
      "inNum\030\030 \001(\r\022\'\n\037nAnalogCurrentModuleChanl"
      "eCount\030\031 \003(\r\"#\n\005range\022\014\n\004fmin\030\001 \001(\002\022\014\n\004f"
      "max\030\002 \001(\002\"\"\n\tanalogmap\022\025\n\rndevicechanel\030"
      "\001 \003(\rb\006proto3"
  };
...
void device::SharedCtor() {
  ::memset(&ochaneldesc_, 0, reinterpret_cast<char*>(&ocompensationmngr_) -
    reinterpret_cast<char*>(&ochaneldesc_) + sizeof(ocompensationmngr_));
  _cached_size_ = 0;
}
...
devicechaneldesc::devicechaneldesc(const devicechaneldesc& from)
  ...
  ::memcpy(&smvmaxgroupnum_, &from.smvmaxgroupnum_,
    reinterpret_cast<char*>(&nanalogcurrentmodulebeginnum_) -
    reinterpret_cast<char*>(&smvmaxgroupnum_) + sizeof(nanalogcurrentmodulebeginnum_));
  // @@protoc_insertion_point(copy_constructor:hqyDeviceConfig.devicechaneldesc)
}

void devicechaneldesc::SharedCtor() {
  ::memset(&smvmaxgroupnum_, 0, reinterpret_cast<char*>(&nanalogcurrentmodulebeginnum_) -
    reinterpret_cast<char*>(&smvmaxgroupnum_) + sizeof(nanalogcurrentmodulebeginnum_));
  _cached_size_ = 0;
}
