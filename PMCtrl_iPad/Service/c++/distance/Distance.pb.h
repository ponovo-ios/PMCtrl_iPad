...
class Items : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Distance.Items) */ {
 public:
  ...
  const ::Distance::SwitchPara& oswitch() const;
  ::Distance::SwitchPara* mutable_oswitch();
  ::Distance::SwitchPara* release_oswitch();
  void set_allocated_oswitch(::Distance::SwitchPara* oswitch);
...
class TRIPMAP : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Distance.TRIPMAP) */ {
 public:
  TRIPMAP();
  virtual ~TRIPMAP();
  ...
  // @@protoc_insertion_point(class_scope:Distance.TRIPMAP)
 private:
...
class SwitchPara : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Distance.SwitchPara) */ {
 public:
  SwitchPara();
  virtual ~SwitchPara();
  ...
  const ::Distance::TRIPMAP& itripbuf(int index) const;
  ::Distance::TRIPMAP* mutable_itripbuf(int index);
  ::Distance::TRIPMAP* add_itripbuf();
  ...
  // @@protoc_insertion_point(class_scope:Distance.SwitchPara)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::Distance::TRIPMAP > itripbuf_;
...
inline const ::Distance::SwitchPara& Items::oswitch() const {
...
inline ::Distance::SwitchPara* Items::mutable_oswitch() {
...
inline ::Distance::SwitchPara* Items::release_oswitch() {
...
inline void Items::set_allocated_oswitch(::Distance::SwitchPara* oswitch) {
  delete oswitch_;
  oswitch_ = oswitch;
  if (oswitch) {
