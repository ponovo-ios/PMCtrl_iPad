...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestItem, odiffer_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 44, -1, sizeof(state)},
  { 56, -1, sizeof(states)},
  { 62, -1, sizeof(StateResultItem)},
  { 72, -1, sizeof(stateResult)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::Differential::protobuf_Differential_2eproto::InitDefaults();
  ...
  _TestItem_default_instance_.get_mutable()->odiffer_ = const_cast< ::Differential::Items*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n\020hqyPUDPara.proto\022\nhqyPudPara\032\022Differen"
      "tial.proto\">\n\nchanelpara\022\022\n\nfamptitude\030\001"
      " \001(\002\022\016\n\006fphase\030\002 \001(\002\022\014\n\004ffre\030\003 \001(\002\"\245\001\n\014a"
      "canalogpara\0228\n\030analogcurrentchanelvalue\030"
      "\001 \003(\0132\026.hqyPudPara.chanelpara\0226\n\026analogv"
      "oltchangelvalue\030\002 \003(\0132\026.hqyPudPara.chane"
      "lpara\022\017\n\007fVoltDC\030\003 \003(\002\022\022\n\nfCurrentDC\030\004 \003"
      "(\002\"\201\001\n\racdigitalpara\0228\n\030analogcurrentcha"
      "nelvalue\030\001 \003(\0132\026.hqyPudPara.chanelpara\0226"
      "\n\026analogvoltchangelvalue\030\002 \003(\0132\026.hqyPudP"
      "ara.chanelpara\"\177\n\006acpara\022.\n\014oacanlogpara"
      "\030\001 \001(\0132\030.hqyPudPara.acanalogpara\0221\n\016oacd"
      "igitalpara\030\002 \001(\0132\031.hqyPudPara.acdigitalp"
      "ara\022\022\n\nnbinaryout\030\003 \001(\r\"z\n\nmanualpara\022#\n"
      "\007oacpara\030\001 \001(\0132\022.hqyPudPara.acpara\022\031\n\021se"
      "ndzeroafterstop\030\002 \001(\010\022\022\n\nndelaytime\030\003 \001("
      "\r\022\030\n\020nIsStopBiChanged\030\004 \001(\r\"\253\001\n\010TestItem"
      "\022(\n\totesttype\030\001 \001(\0162\025.hqyPudPara.para_ty"
      "pe\022\'\n\007omanual\030\002 \001(\0132\026.hqyPudPara.manualp"
      "ara\022&\n\nostatepara\030\003 \001(\0132\022.hqyPudPara.sta"
      "tes\022$\n\007odiffer\030\004 \001(\0132\023.Differential.Item"
      "s\"\264\001\n\005state\022\016\n\006nIndex\030\001 \001(\r\022#\n\007oacpara\030\002"
      " \001(\0132\022.hqyPudPara.acpara\022\023\n\013nTrigerType\030"
      "\003 \001(\r\022\024\n\014nTrigerLogic\030\004 \001(\r\022\023\n\013nTirgerTi"
      "me\030\005 \001(\r\022\020\n\010sGpstime\030\006 \001(\r\022\021\n\tnsGpsTime\030"
      "\007 \001(\r\022\021\n\tnBiValide\030\010 \001(\r\"=\n\006states\022\"\n\007os"
      "tates\030\001 \003(\0132\021.hqyPudPara.state\022\017\n\007nisloo"
      "p\030\002 \001(\r\"\211\001\n\017StateResultItem\022\016\n\006nindex\030\001 "
      "\001(\r\022\022\n\nsecondtime\030\002 \001(\r\022\016\n\006nstime\030\003 \001(\r\022"
      "\023\n\013oactivetype\030\004 \001(\r\022\021\n\tnBinstate\030\005 \001(\r\022"
      "\032\n\022ncurrentstateIndex\030\006 \001(\r\"9\n\013stateResu"
      "lt\022*\n\005oitem\030\001 \003(\0132\033.hqyPudPara.StateResu"
      "ltItem*K\n\tpara_type\022\017\n\013manual_type\020\000\022\016\n\n"
      "state_type\020\001\022\014\n\010iec_type\020\002\022\017\n\013differ_typ"
  ...
  ::Differential::protobuf_Differential_2eproto::AddDescriptors();
...
const int TestItem::kOdifferFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
TestItem::TestItem(const TestItem& from)
  ...
  if (from.has_odiffer()) {
    odiffer_ = new ::Differential::Items(*from.odiffer_);
  } else {
    odiffer_ = NULL;
  }
...
// @@protoc_insertion_point(message_clear_start:hqyPudPara.TestItem)
  ...
  ostatepara_ = NULL;
  if (GetArenaNoVirtual() == NULL && odiffer_ != NULL) {
    delete odiffer_;
  }
  odiffer_ = NULL;
  otesttype_ = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:hqyPudPara.TestItem)
  ...
  if (from.has_odiffer()) {
    mutable_odiffer()->::Differential::Items::MergeFrom(from.odiffer());
  }
  if (from.otesttype() != 0) {
...
void TestItem::InternalSwap(TestItem* other) {
  ...
  std::swap(odiffer_, other->odiffer_);
...
::Differential::Items* TestItem::release_odiffer() {
...
void TestItem::set_allocated_odiffer(::Differential::Items* odiffer) {
  delete odiffer_;
  odiffer_ = odiffer;
  if (odiffer) {
