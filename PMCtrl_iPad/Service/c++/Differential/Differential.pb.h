...
class CommonPara : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Differential.CommonPara) */ {
 public:
  ...
  // float Ugroup1 = 35;
  void clear_ugroup1();
  static const int kUgroup1FieldNumber = 35;
  float ugroup1() const;
  void set_ugroup1(float value);

  // float Ugroup2 = 36;
  void clear_ugroup2();
  static const int kUgroup2FieldNumber = 36;
  float ugroup2() const;
  void set_ugroup2(float value);
...
// float fStart = 5;
inline void HarmonicRatio::clear_fstart() {
  fstart_ = 0;
}
inline float HarmonicRatio::fstart() const {
  // @@protoc_insertion_point(field_get:Differential.HarmonicRatio.fStart)
  return fstart_;
}
inline void HarmonicRatio::set_fstart(float value) {
...
// float fEnd = 6;
inline void HarmonicRatio::clear_fend() {
  fend_ = 0;
}
inline float HarmonicRatio::fend() const {
  // @@protoc_insertion_point(field_get:Differential.HarmonicRatio.fEnd)
  return fend_;
}
inline void HarmonicRatio::set_fend(float value) {
...
// float Ugroup1 = 35;
inline void CommonPara::clear_ugroup1() {
  ugroup1_ = 0;
}
inline float CommonPara::ugroup1() const {
  // @@protoc_insertion_point(field_get:Differential.CommonPara.Ugroup1)
  return ugroup1_;
}
inline void CommonPara::set_ugroup1(float value) {
...
// float Ugroup2 = 36;
inline void CommonPara::clear_ugroup2() {
  ugroup2_ = 0;
}
inline float CommonPara::ugroup2() const {
  // @@protoc_insertion_point(field_get:Differential.CommonPara.Ugroup2)
  return ugroup2_;
}
inline void CommonPara::set_ugroup2(float value) {
