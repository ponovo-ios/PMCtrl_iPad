...
class BinaryinSetting : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:hqyBinaryInPackage.BinaryinSetting) */ {
 public:
  ...
  // uint32 bitime = 2;
  void clear_bitime();
  static const int kBitimeFieldNumber = 2;
  ::google::protobuf::uint32 bitime() const;
  void set_bitime(::google::protobuf::uint32 value);

  // uint32 BinaryMode = 3;
  void clear_binarymode();
  static const int kBinaryModeFieldNumber = 3;
  ::google::protobuf::uint32 binarymode() const;
  void set_binarymode(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::uint32 bitime_;
  ::google::protobuf::uint32 binarymode_;
  mutable int _cached_size_;
  friend struct  protobuf_hqyBinaryInSetting_2eproto::TableStruct;
};
// ===================================================================
...
// uint32 bitime = 2;
inline void BinaryinSetting::clear_bitime() {
  bitime_ = 0u;
}
inline ::google::protobuf::uint32 BinaryinSetting::bitime() const {
  // @@protoc_insertion_point(field_get:hqyBinaryInPackage.BinaryinSetting.bitime)
  return bitime_;
}
inline void BinaryinSetting::set_bitime(::google::protobuf::uint32 value) {
...
// uint32 BinaryMode = 3;
inline void BinaryinSetting::clear_binarymode() {
  binarymode_ = 0u;
}
inline ::google::protobuf::uint32 BinaryinSetting::binarymode() const {
  // @@protoc_insertion_point(field_get:hqyBinaryInPackage.BinaryinSetting.BinaryMode)
  return binarymode_;
}
inline void BinaryinSetting::set_binarymode(::google::protobuf::uint32 value) {
