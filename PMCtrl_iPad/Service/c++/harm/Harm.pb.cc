...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(HarmAnalog, block_),
  ~0u,  // no _has_bits_
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      "\n\nHarm.proto\022\004Harm\032\022OutPutCommon.proto\"\363"
      ...
      "\005bLock\030\013 \001(\010\"3\n\006DCPara\022\022\n\nanalogvolt\030\001 \003"
      "(\002\022\025\n\ranalogCurrent\030\002 \003(\002b\006proto3"
  };
...
const int HarmAnalog::kBLockFieldNumber;
...
void HarmAnalog::SerializeWithCachedSizes(
  ...
  // bool bLock = 11;
  if (this->block() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(11, this->block(), output);
  }
...
::google::protobuf::uint8* HarmAnalog::InternalSerializeWithCachedSizesToArray(
  ...
  // bool bLock = 11;
  if (this->block() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(11, this->block(), target);
  }
...
// bool bLock = 11;
void HarmAnalog::clear_block() {
  block_ = false;
}
bool HarmAnalog::block() const {
  // @@protoc_insertion_point(field_get:Harm.HarmAnalog.bLock)
  return block_;
}
void HarmAnalog::set_block(bool value) {
...
void DCPara::SerializeWithCachedSizes(
  ...
  if (this->analogvolt_size() > 0) {
    ...
    ::google::protobuf::internal::WireFormatLite::WriteFloatArray(
      this->analogvolt().data(), this->analogvolt_size(), output);
  }
  ...
  if (this->analogcurrent_size() > 0) {
    ...
    ::google::protobuf::internal::WireFormatLite::WriteFloatArray(
      this->analogcurrent().data(), this->analogcurrent_size(), output);
  }
...
::google::protobuf::uint8* DCPara::InternalSerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->analogvolt_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteFloatNoTagToArray(this->analogvolt(i), target);
  }
  ...
  for (int i = 0; i < this->analogcurrent_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteFloatNoTagToArray(this->analogcurrent(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Harm.DCPara)
  ...
  // repeated float analogvolt = 1;
  {
    unsigned int count = this->analogvolt_size();
  ...
  // repeated float analogCurrent = 2;
  {
    unsigned int count = this->analogcurrent_size();
    size_t data_size = 4UL * count;
    if (data_size > 0) {
      total_size += 1 +
        ::google::protobuf::internal::WireFormatLite::Int32Size(data_size);
